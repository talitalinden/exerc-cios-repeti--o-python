...
# um programa que leia as um conjunto indeterminado de temperaturas, e informe ao 
...
print()
print(f'A menor temperatura: {menor:.2f}')
print(f'A maior temperatura: {maior:.2f}')
